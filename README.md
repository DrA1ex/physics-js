...
- Optimization Tree visualization 2: [link](https://dra1ex.github.io/physics-js/examples/collision/?debug=1&debug_tree=1&debug_body=0&debug_velocity=0&debug_boundary=0&debug_point=0)
