...
const rampSide = [
    new Vector2(0, 1), new Vector2(0, 0), new Vector2(0.01, 0),
    ...cycloidPoints
];
...
BootstrapInstance.addRigidBody(new CircleBody(
    xOffset + ballRadius + rampWidth * 0.05,
    yOffset - ballRadius - rampHeight * 0.05, ballRadius,
    100
));
