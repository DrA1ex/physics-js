...
/**
 * @extends ParametricBasedAnimation<ColorAnimation>
 */
...
export class PercentAnimation extends ParametricBasedAnimation {
    #from;
    #to;
    #size;
    ...
    constructor(from, to, step) {
        ...
        if (Number.isNaN(from) || Number.isNaN(to)) {
            throw new Error("Invalid parameter values: value is not a number");
        }
