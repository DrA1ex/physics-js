...
export class Particle {
    ...
    /** @type {Body} */
    #body;
    /** @type {BodyRenderer|IRenderObject} */
    #renderObject;
    ...
    /**
     * @param {Body} body
     * @param {BodyRenderer|IRenderObject} renderObj
     */
    constructor(body, renderObj) {
        this.#body = body;
    ...
    setState(key) {
        ...
        for (const keyframe of newState.keyframes) {
            ...
            if (initial === undefined) throw new Error(`Unsupported property "${keyframe.property}", type "${this.constructor.name}"`);
