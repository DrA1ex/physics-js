...
export class ParticleAnimationHelper {
    static applyValue(property, particle, value) {
        switch (property) {
            case AnimationProperty.opacity:
                particle.renderObject.opacity = value;
                break;
            case AnimationProperty.fillStyle:
                particle.renderObject.fillStyle = value;
                break;
            case AnimationProperty.strokeStyle:
                particle.renderObject.strokeStyle = value;
                break;
            case AnimationProperty.color:
                particle.renderObject.color = value;
                break;
    ...
    static getValue(property, particle) {
        switch (property) {
            case AnimationProperty.opacity:
                return particle.renderObject.opacity;
            case AnimationProperty.fillStyle:
                return particle.renderObject.fillStyle;
            case AnimationProperty.strokeStyle:
                return particle.renderObject.strokeStyle;
            case AnimationProperty.color:
                return particle.renderObject.color;
            case AnimationProperty.radius:
