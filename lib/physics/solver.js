...
export class ImpulseBasedSolver {
    ...
    #applyNormalImpulse(collisionInfo) {
        ...
        let impulseDelta = Math.min(0, (1 + restitution) * (normal.dot(velocityDelta) - bias) / normalMass);
    ...
    #correctPosition(collisionInfo) {
        ...
        const correction = Math.max(0, collision.overlap - collision.overlap / 2 - this.allowedOverlap);
