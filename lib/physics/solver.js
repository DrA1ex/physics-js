...
import {SpatialTree} from "./common/tree.js";
import * as GeomUtils from "../utils/geom.js";
import {ObjectStack} from "../misc/stack.js";
import {Body} from "./body/base.js";
import {CollisionInfo} from "./common/collision.js";
import {Collider} from "./collider/base.js";
...
export class ImpulseBasedSolver {
    ...
    /** @type {ObjectStack<CollisionInfo>} */
    #collisionInfoPool;
    ...
    constructor() {
        this.#collisionInfoPool = new ObjectStack(() => new CollisionInfo());
    }
    ...
    solve(delta) {
        ...
        if (this.warming) {
            this.#collisionInfoPool.restore()
    ...
    #processPairCollisions(body1, body2) {
        ...
        const collision = Collider.detectCollision(body1, body2);
        if (collision.result) {
    ...
    #prepareCollisionInfo(collision) {
        ...
        result.normalImpulse = 0;
        result.tangentImpulse = 0;
