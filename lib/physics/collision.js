...
export class Collider {
    ...
    detectCollision(body2) {
        ...
        let collision = new Collision(false);
...
export class PolygonCollider extends Collider {
    ...
    static detectCollision(body1, body2) {
        ...
        let collisionA = CollisionUtils.getCollisionPoint(points, normal);
        ...
        if (!pointAContained.result) {
            ...
            const alternativeCollision = CollisionUtils.getCollisionPoint(otherPoints, centralTangent);
