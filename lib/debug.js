...
import {Collider} from "./physics/collision.js";
...
export class Debug {
    ...
    constructor(options = null) {
        ...
        this.showTreeSegments = options?.showTreeSegments ?? true;
    ...
    #drawTreeDebug(ctx, tree) {
        const showTreeLeafs = this.showTreeLeafs;
        const self = this;
